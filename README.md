...
## Description
This is an administrative portal for a point of sale system that I worked on with a couple friends. The portal accesses a hosted database that I created to handle login, registration, inventory management, etc. I used a bootstrap template and a couple small snipets of code from online (see "code" section below), but everthing else here -- including all PHP code -- is my own personal work. 
