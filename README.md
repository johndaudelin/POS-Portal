...
## Description
This is an administrative portal that I created (unpaid) for a game store's point of sale system, although the POS system was never actually used. The portal accesses a hosted MySQL database that I created to handle login, registration, inventory management, etc. I used a bootstrap template and a couple small snipets of code from online articles (see "code" section below), but everthing else here -- including all PHP code -- is my own personal work. 
