<?php
 ob_start();
 session_start();
 require_once 'db/login_connection.php';
?>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
              ...
              <div>
                <input type="password" name="pass" class="form-control" placeholder="Password" value="<?php echo $pass; ?>" required="" />
              </div>
              <div>
                <button type="submit" class="btn btn-default submit" name="btn-login">Log in</button>
                <a class="reset_pass" href="pass_reset.php">Lost your password?</a>
              </div>
