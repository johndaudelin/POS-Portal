                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="images/<?php if (file_exists("images/".$_SESSION['id'].".png")) { echo $_SESSION['id']; } else { echo "user"; }?>.png?=<?php echo date("Y m d H i s"); ?>" style="height: 200px; width: auto;" alt="Avatar" title="Avatar">
                        </div>
                     </div>
					          </div>
                    ...
                    <ul class="list-unstyled user_data">
                      ...
                      <li class="m-top-xs">
                        <i class="glyphicon glyphicon-lock"></i><span type="password">  <?php echo str_repeat ('*', $_SESSION['pass_num_digits']); ?>
                      </li>
                    </ul>
		
                    <h4>Actions</h4>
                    <a class="btn btn-success" href = "edit_info.php"><i class="fa fa-edit m-right-xs"></i> Edit Information</a>
                    <a class="btn btn-primary" href="new_account.php"><i class="fa fa-user o m-right-xs"></i> Add Administrator</a>
                    <a class="btn btn-success" href="change_photo.php"><i class="fa fa-camera o m-right-xs"></i> Change Photo</a>
                  </div>
                </div>
              </div>
            </div>
